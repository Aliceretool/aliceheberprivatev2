...
const metrics = [
  {
    ...
    val: parseFloat({{cohort_eol_vsavg.value}} || "0"), 
    phrases: [
  ...
  {
    name: "LSAT",
    val: parseFloat({{cohort_lsat_vsavg.value}} || "0"),
    phrases: [
  ...
  {
    name: "Attendance",
    val: parseFloat({{cohort_att_vsavg.value}} || "0"),
    phrases: [
  ...
  },
  {
    ...
    val: parseFloat({{cohort_pr_vsavg.value}} || "0"),
    phrases: [
  ...
  {
    name: "Gateway",
    val: parseFloat({{cohort_gw_vsavg.value}} || "0"),
    phrases: [
