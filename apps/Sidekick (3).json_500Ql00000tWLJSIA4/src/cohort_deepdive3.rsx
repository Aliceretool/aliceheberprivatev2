...
>
  ...
  <Body>
    <TextInput
      id="cohort_dd_search3"
      label="Search"
      labelPosition="top"
      placeholder="Enter value"
    />
    <Multiselect
      id="cohort_dd_cohortSelect3"
      captionByIndex=""
      colorByIndex=""
      ...
      value="{{ cohort_cohortSelect3.value }}"
      values="{{item.value}}"
      wrapTags={true}
    >
      <Event
    ...
    <Multiselect
      ...
      value="{{ cohort_companySelect3.value }}"
      values="{{item.value}}"
      wrapTags={true}
    >
      <Event
    ...
    <Multiselect
      ...
      showSelectionIndicator={true}
      tooltipByIndex=""
      value="{{ cohort_riskSelect2.value }}"
      values=""
      wrapTags={true}
    >
    ...
    <Table
      ...
      defaultFilters={{
        0: {
          ...
          columnId: "f9a6b",
          operator: "intersects",
          value: "{{ cohort_dd_cohortSelect3.value }}",
          disabled: false,
        },
        1: {
          id: "af58e",
          columnId: "4f6ec",
          operator: "intersects",
          value: "{{cohort_dd_companySelect3.value}}",
          disabled: false,
        },
        2: {
          id: "0e866",
          columnId: "a5b5f",
          operator: "intersects",
          value: "{{ cohort_dd_riskSelect3.value }}",
          disabled: false,
        },
        3: {
          id: "d9832",
          columnId: "8a644",
          operator: "includes",
          value: "{{cohort_dd_statusSelect3.value}}",
          disabled: false,
        },
      }}
      ...
      rowHeight="small"
      searchTerm="{{ cohort_dd_search3.value }}"
      showFooter={true}
      showHeader={true}
      style={{}}
    >
