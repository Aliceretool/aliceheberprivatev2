...
>
  ...
  >
    ...
    <Switch
      ...
      labelCaption="Includes all coaches with 10+ on-programme learners"
      style={{
    ...
    >
      <Event
        ...
        params={{
          map: {
            src: "localStorage.setValue('user_toggle_pref', benchSwitch.value)",
          },
        }}
        pluginId=""
        type="script"
  ...
  >
    <Text
      ...
      verticalAlign="center"
    />
    <Include src="./trendContainer2.rsx" />
  </View>
</Container>
