...
>
  ...
  <View id="00030" viewKey="View 1">
    <Include src="./EolTrendContainer3.rsx" />
    <Container
      id="LsatTrendContainer12"
    ...
    >
      <Header>
        <Text
          ...
          value="**LSAT - {{ LsatTrendContainer12.currentViewKey }} Trend**"
          verticalAlign="center"
        />
        <Tabs
          id="tabs14"
          ...
          targetContainerId="LsatTrendContainer12"
          value="{{ self.values[0] }}"
        >
    ...
    >
      <Header>
        <Text
          ...
          value="**Attendance - {{ LsatTrendContainer13.currentViewKey }} Trend**"
          verticalAlign="center"
        />
        <Tabs
          id="tabs15"
          ...
          itemMode="static"
          navigateContainer={true}
          targetContainerId="LsatTrendContainer13"
          value="{{ self.values[0] }}"
        >
          <Option id="00030" value="Tab 1" />
          <Option id="00031" value="Tab 2" />
    ...
    >
      <Header>
        <Text
          ...
          value="**Progress Review Completion - {{ LsatTrendContainer14.currentViewKey }} Trend**"
          verticalAlign="center"
        />
        <Tabs
          id="tabs16"
          ...
          itemMode="static"
          navigateContainer={true}
          targetContainerId="LsatTrendContainer14"
          value="{{ self.values[0] }}"
        >
          <Option id="00030" value="Tab 1" />
          <Option id="00031" value="Tab 2" />
    ...
    >
      <Header>
        <Text
          ...
          value="**Gateway Bookings - {{ LsatTrendContainer11.currentViewKey }} Trend**"
          verticalAlign="center"
        />
        <Tabs
          id="tabs17"
          ...
          itemMode="static"
          navigateContainer={true}
          targetContainerId="LsatTrendContainer11"
          value="{{ self.values[0] }}"
        >
          <Option id="00030" value="Tab 1" />
          <Option id="00031" value="Tab 2" />
