...
>
  ...
  <View id="00030" viewKey="View 1">
    <Text id="text584" hidden="true" value="Best" verticalAlign="center" />
    <Text
      id="cohort_comp_best5"
      hidden="true"
      value="Best"
      verticalAlign="center"
    />
    <Text id="text585" hidden="true" value="Average" verticalAlign="center" />
    <Text
      id="cohort_comp_avg5"
      hidden="true"
      value="Best"
      verticalAlign="center"
    />
    <Text id="text586" hidden="true" value="vs Avg." verticalAlign="center" />
    <Text
      id="cohort_comp_vsavg5"
      hidden="true"
      value="Best"
      verticalAlign="center"
    />
