...
>
  <Header>
    ...
    <Tabs
      ...
      targetContainerId="EolTrendContainer4"
      value="{{ self.values[0] }}"
    >
  ...
  <View id="00032" viewKey="Monthly">
    ...
    >
      <Series
        ...
        xDataMode="manual"
        yAxis="y"
        yData="{{ chart_transformer.value['Pod EOL'] }}"
        yDataMode="manual"
        zData={null}
        zDataMode="manual"
      />
      <Series
        ...
        xDataMode="source"
        yAxis="y"
        yData="{{ chart_transformer.value['Company EOL'] }}"
        yDataMode="manual"
        zData={null}
        zDataMode="manual"
      />
      <Series
        ...
        xDataMode="source"
        yAxis="y"
        yData="{{ chart_transformer.value['Best Coach EOL'] }}"
        yDataMode="manual"
        zData={null}
        zDataMode="manual"
      />
