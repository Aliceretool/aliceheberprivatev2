...
>
  ...
  <View id="00030" viewKey="View 1">
    ...
    <Text
      id="text603"
      value={
        'Apprentice Completed: {{ \n  item.progress_review_summary?.latest_progress_review?.apprentice_completed_at \n    ? "✅ Yes" \n    : "❌ No" \n}}'
      }
      verticalAlign="center"
    />
    <Text
      id="text604"
      value={
        'Manager Completed: {{ \n  item.progress_review_summary?.latest_progress_review?.apprentice_manager_completed_at \n    ? "✅ Yes" \n    : "❌ No" \n}}'
      }
      verticalAlign="center"
    />
    <Text
      id="text605"
      value={
        'Coach Completed: {{ \n  item.progress_review_summary?.latest_progress_review?.coach_completed_at \n    ? "✅ Yes" \n    : "❌ No" \n}}'
      }
      verticalAlign="center"
    />
    <Text
      id="text602"
      value={
        'Async Recommendation: {{ \n  item.progress_review_summary?.latest_progress_review?.async_recommendation \n    ? "✅ Yes" \n    : "❌ No" \n}}'
      }
      verticalAlign="center"
    />
  </View>
