...
>
  ...
  <View id="00030" viewKey="View 1">
    <Multiselect
      id="cohort_cohortSelect"
      data="{{ getFilterOptions_dd.value.cohorts }}"
    ...
    <Multiselect
      id="cohort_companySelect"
      data="{{getFilterOptions_dd.value.companies}}"
      emptyMessage="No options"
      label=""
      labelPosition="top"
      labels="{{item.label}}"
