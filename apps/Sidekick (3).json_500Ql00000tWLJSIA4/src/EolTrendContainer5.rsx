...
>
  <Header>
    <Text
      ...
      value="**EOL - {{ EolTrendContainer5.currentViewKey }} Trend**"
    ...
    <Tabs
      ...
      targetContainerId="EolTrendContainer5"
      value="{{ self.values[0] }}"
    >
  ...
  <View id="00032" viewKey="Monthly">
    ...
    >
      <Series
        ...
        xDataMode="source"
        yAxis="y"
        yData="{{ formatDataAsObject(best_average_historic_data2.value).eol_me }}"
        yDataMode="source"
        zData={null}
        zDataMode="manual"
      />
      <Series
        ...
        xDataMode="source"
        yAxis="y"
        yData="{{ formatDataAsObject(best_average_historic_data2.value).eol_avg }}"
        yDataMode="source"
        zData={null}
        zDataMode="manual"
      />
      <Series
        ...
        xDataMode="source"
        yAxis="y"
        yData="{{ formatDataAsObject(best_average_historic_data2.value).eol_best }}"
        yDataMode="source"
        zData={null}
        zDataMode="manual"
      />
