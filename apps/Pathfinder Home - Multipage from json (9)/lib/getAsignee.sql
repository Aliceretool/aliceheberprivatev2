SELECT i.assigned_to, i.created_by, i.projectID, i.project_typeID, p.project, pt.project_type,u.firstName AS assignedfirstName,u.avatarURL AS assignedAvatarURL,
