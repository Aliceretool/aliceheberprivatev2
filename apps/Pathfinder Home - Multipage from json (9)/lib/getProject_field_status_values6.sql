...
AND pf.projectID = {{current_project_id6.value}}
-- AND pf.cascade = 0 
AND pt.project_typeID = {{ getIssue13.data.project_typeID[0] }}
...
-- INNER JOIN project_field_type_value pv ON pt.project_field_project_typeID = pv.project_field_project_typeID
-- WHERE
-- pf.project_field = 'Status'
-- AND
--  pf.projectID = {{current_project_id6.value}} 
