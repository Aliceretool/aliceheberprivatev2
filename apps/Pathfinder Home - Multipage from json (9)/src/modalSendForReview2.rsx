...
>
  ...
  <Body>
    <Select
      ...
      data="{{ getUsers_qc_supervisors2.data }}"
  ...
  <Footer>
    <Button id="button123" text="{{ i18n.t('Send for Review') }}">
      <Event
        event="click"
        method="trigger"
        params={{ ordered: [] }}
        pluginId="updIssue_under_review"
        type="datasource"
        waitMs="0"
        waitType="debounce"
      />
      <Event
        ...
        method="trigger"
        params={{ ordered: [] }}
        pluginId="upd_assignto_supervisor2"
        type="datasource"
        waitMs="0"
        waitType="debounce"
      />
      <Event
        ...
        method="trigger"
        params={{ ordered: [] }}
        pluginId="insComments_sendforreview2"
        type="datasource"
        waitMs="0"
        waitType="debounce"
      />
